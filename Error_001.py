"""
A partir del codigo SimxJDoub_002 se procede a reajustar el coigo para generar 
el grafico correspondiente al error 
cambios:
1. recorte de lineas 25 a 29 (no necesitamos los graficos)
2. recorte de lineas 136 a 138 (no necesario grafico de minimos)
...
for i in range (len(ref)): 
    ...
    calc.append(Jota) # Esta es la linea que nada mas guarda un valor de J en ves de los 3 que quiero 
